...
// Fragment shader - ethereal aurora/smoke effect
const fragmentShader = `
  ...
  void main() {
    ...
    // Very slow time progression for ethereal feel
    float time = uTime * 0.08;
    
    // Mouse influence (subtle)
    vec2 mouseInfluence = (uMouse - 0.5) * 0.15;
    
    // Create multiple layers of flowing noise
    ...
    // Create color palette - muted blues and grays
    vec3 color1 = vec3(0.08, 0.10, 0.14); // Deep dark blue-gray
    vec3 color2 = vec3(0.15, 0.20, 0.28); // Muted blue
    vec3 color3 = vec3(0.22, 0.28, 0.35); // Soft steel blue
    vec3 color4 = vec3(0.12, 0.15, 0.20); // Dark slate
...
export function HomeBackground() {
  ...
  useEffect(() => {
    ...
    // Create full-screen quad with shader
